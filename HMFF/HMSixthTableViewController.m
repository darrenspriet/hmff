...
#import "HMSixthTableViewController.h"

@interface HMSixthTableViewController ()

@end

@implementation HMSixthTableViewController
...
-(void)loadData{
    ...
    [self setBand: [tempArray objectAtIndex:5]];
