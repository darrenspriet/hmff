...
#import "HMFourthTableViewController.h"

@interface HMFourthTableViewController ()

@end

@implementation HMFourthTableViewController
...
-(void)loadData{
    ...
    [self setBand: [tempArray objectAtIndex:3]];
