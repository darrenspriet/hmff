...
#import "HMFifthTableViewController.h"

@interface HMFifthTableViewController ()

@end

@implementation HMFifthTableViewController
...
-(void)loadData{
    ...
    [self setBand: [tempArray objectAtIndex:4]];
